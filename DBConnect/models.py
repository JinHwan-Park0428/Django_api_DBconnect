...
class SkdevsecBoard(models.Model):
    ...
    bfile = models.FileField(max_length=200, upload_to=file_upload_path_for_db, blank=False, null=False)
...
class SkdevsecProduct(models.Model):
    ...
    pname = models.CharField(max_length=50)
    pcate = models.CharField(max_length=50)
    pimage = models.FileField(max_length=200, upload_to=file_upload_path_for_db, blank=False, null=False)
